...
Establishing a simple, physical and accurate model for the response in the radial distribution, would also help me to model response in the angular distribution (determining halo shapes) and velocity distribution, by following this approach of using a combination of simulations and other numerical experiments.

\textbf{In the first 1.5 years at York with Prof. Kannan, I plan to primarily study the effect of feedbacks on the galaxy through simulation. Extending my time correlation analysis, I aim to understand the connection between feedback history to the properties of gas and overall baryon distribution in the galaxy. Then I plan to extend this connection to the properties of dark matter haloes, which would significantly benefit from the expertise of Prof. Vogelsberger at MIT in the next 1.5 years.} 
