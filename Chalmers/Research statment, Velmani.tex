...
\geometry{left=.45in, top=.75in, right=.5in, bottom=.8in, footskip=.5cm}
...
I also look forward to collaborating with other researchers at Chalmers, in exploring various other interesting questions about the dark matter haloes, galaxies and other objects that build the large-scale structure of the Universe.
